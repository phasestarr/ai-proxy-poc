...
class AuthSession(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("state IN ('active', 'expired')", name="ck_auth_sessions_state"),
    ...
    expired_reason_code: Mapped[str | None] = mapped_column(String(64), nullable=True)
    expired_reason: Mapped[str | None] = mapped_column(String(255), nullable=True)
    superseded_by_session_id: Mapped[str | None] = mapped_column(
