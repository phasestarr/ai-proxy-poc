...
class UsageLedgerEvent(Base):
    ...
    web_fetch_requests: Mapped[int | None] = mapped_column(nullable=True)
    ...
    code_interpreter_requests: Mapped[int | None] = mapped_column(nullable=True)
    shell_requests: Mapped[int | None] = mapped_column(nullable=True)
